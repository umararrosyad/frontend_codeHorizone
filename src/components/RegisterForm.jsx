    ...
    <div className="flex justify-center mx-auto w-full ">
      <div class="w-full max-w-lg mx-auto p-4 bg-white border flex flex-col border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
        <form className="" onSubmit={handleSubmit}>
          <div className="">
            <p className="flex justify-center font-sans text-3xl font-bold antialiased  leading-normal text-inherit">Daftar Sekarang</p>
          ...
          <div className="flex flex-col mt-4">
            <div className="relative h-11 w-full">
              ...
              <button className="absolute right-3 top-3 text-gray-500" onClick={togglePasswordVisibility} type="button">
          ...
          <div className="pt-4">
            <button
              className="block w-full select-none rounded-lg bg-gradient-to-tr bg-peach from-gray-900 to-gray-800 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
              type="submit"
            >
              REGISTER
            </button>
